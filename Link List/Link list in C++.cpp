...
void RecursionPrint(Node *head)
{
    ...
    cout<<head->data<<" ";
    RecursionPrint(head->link);
}

void RecursionRevPrint(Node *head)
{
    if(head==NULL)return;

    RecursionRevPrint(head->link);
    cout<<head->data<<" ";
}
...
int main()
{
    ...
    printf("press 7 for Recursive Reverse\n");
    printf("press 8 for Recursive Print\n");
    printf("press 9 for Recursive Reverse Print\n");
